    ...
    <>
      ...
      <div className="flex flex-col items-center md:flex-row md:space-x-20 lg:space-x-32 ">
        ...
        <div className="text-left">
          ...
          <span className=" mb-8 inline-block">$2&nbsp;999</span>
        ...
        <div className="md:space-y-[20px] lg:space-y-8">
          ...
          <div className="rounded-xl overflow-hidden mb-[20px] md:mb-0">
            <picture>
              ...
              <Image src="/img/product-xx99-mark-two-headphones/mobile/image-gallery-2.jpg" alt="gallery item 2" width={250} height={250} />
            </picture>
          </div>
        </div>
        <div>
          <div className="rounded-xl overflow-hidden mb-[20px] md:mb-0">
            <picture>
              ...
              <Image src="/img/product-xx99-mark-two-headphones/mobile/image-gallery-3.jpg" alt="gallery item 3" width={250} height={250} />
            </picture>
          </div>
        </div>
      </div>
